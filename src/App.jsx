  ...
  const [todos, setTodos] = useState([
    {
      ...
      description: "Desenvolver a funcionalidade X conforme especificado no documento de requisitos.",
      category: "Trabalho",
      isCompleted: false,
    },
    {
    ...
    },
    {
      id: 3,
      text: "Estudar React",
      description: "Revisar os conceitos fundamentais e fazer os exercícios do capítulo 5.",
      category: "Estudos",
      isCompleted: false,
    },
  ]);
